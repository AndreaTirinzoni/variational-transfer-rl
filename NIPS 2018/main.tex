...
\begin{figure*}[t]
  ...
  \end{subfigure}
  \caption{(a) transfer from $10$ sources in Cartpole, (b) transfer from $10$ source tasks in Mountain Car, and (c) transfer from $10$ sources in Maze \ref{fig:maze6}---see App. \ref{}.}

...
\begin{figure*}[t] 
  \begin{subfigure}[b]{0.15\textwidth}
    \includegraphics[trim=0.0cm 0.0cm 0.0cm 0.0cm,clip=true,height=3cm, width=2.0cm]{images/maze/maze13.png}
    \caption{}
  \end{subfigure}
  \begin{subfigure}[b]{0.27\textwidth}
